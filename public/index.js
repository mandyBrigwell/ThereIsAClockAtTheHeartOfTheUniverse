...
var renderInfo = "Render mode for this " + ["instance", "iteration", "hash"][~~(fxrand()*3)] + " is " + renderModeDescriptions[renderMode] + ", using a " + paletteDescription + " " + ["colour scheme", "palette", "colour variation", "tint"][~~(fxrand()*4)] + ". The render is in " + (darkMode == true ? "dark mode" : "light mode") + " with a " + ["faint", "faded", "gentle", "delicate", "subtle"][~~(fxrand()*5)] + " tracework of " + (overlayModeSquare == true ? "squares" : "circles") + " overlaid to add texture and depth.\n\nThe rendering process " + ["consists of", "comprises", "is", "takes place over", "requires"][~~(fxrand()*5)] + " " + maxFrames + " frames, and has a density of " + densityValue + " out of a possible 128. Initial rotation is " + ~~(rotationOffset*100)/100 + " radians, with further increments of " + (1/smallRotation == ~~(1/smallRotation) ? "1 radian" : "1/" + smallRotation + " of a radian") + " per iteration. Large-scale texture is added every " + overlayKey + " frames. All output is generated " + ["entirely", "completely", "totally", "fully"][~~(fxrand()*4)] + " in code.";
